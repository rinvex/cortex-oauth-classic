...
Breadcrumbs::for('adminarea.cortex.auth.admins.clients', function (Generator $breadcrumbs, Admin $admin) {
...
Breadcrumbs::for('adminarea.cortex.auth.admins.auth_codes', function (Generator $breadcrumbs, Admin $admin) {
    $breadcrumbs->parent('adminarea.cortex.auth.admins.index');
    $breadcrumbs->push(strip_tags($admin->username), route('adminarea.cortex.auth.admins.edit', ['admin' => $admin]));
    $breadcrumbs->push(trans('cortex/oauth::common.auth_codes'), route('adminarea.cortex.auth.admins.auth_codes', ['admin' => $admin]));
});

Breadcrumbs::for('adminarea.cortex.auth.admins.access_tokens', function (Generator $breadcrumbs, Admin $admin) {
    $breadcrumbs->parent('adminarea.cortex.auth.admins.index');
    $breadcrumbs->push(strip_tags($admin->username), route('adminarea.cortex.auth.admins.edit', ['admin' => $admin]));
...
Breadcrumbs::for('adminarea.cortex.auth.members.auth_codes', function (Generator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('adminarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('adminarea.cortex.auth.members.edit', ['member' => $member]));
    $breadcrumbs->push(trans('cortex/oauth::common.auth_codes'), route('adminarea.cortex.auth.members.auth_codes', ['member' => $member]));
});

Breadcrumbs::for('adminarea.cortex.auth.members.access_tokens', function (Generator $breadcrumbs, Member $member) {
    $breadcrumbs->parent('adminarea.cortex.auth.members.index');
    $breadcrumbs->push(strip_tags($member->username), route('adminarea.cortex.auth.members.edit', ['member' => $member]));
...
Breadcrumbs::for('adminarea.cortex.oauth.clients.create', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('adminarea.cortex.oauth.clients.edit', function (Generator $breadcrumbs, Client $client) {
    $breadcrumbs->parent('adminarea.cortex.oauth.clients.index');
    $breadcrumbs->push(strip_tags($client->name), route('adminarea.cortex.oauth.clients.edit', ['client' => $client]));
});

Breadcrumbs::for('adminarea.cortex.oauth.clients.auth_codes', function (Generator $breadcrumbs, Client $client) {
...
Breadcrumbs::for('adminarea.cortex.oauth.clients.access_tokens', function (Generator $breadcrumbs, Client $client) {
    $breadcrumbs->parent('adminarea.cortex.oauth.clients.edit', $client);
